...
export default function StatCardSummary({ Stat, Icon, sortBy }) {
  return (
    <div className="mt-6 bg-gray-400 px-2 py-2 last:mb-36">
      ...
      <div className="flex flex-col">
        {players
          ...
          .slice(0, 5)
          .map(({ playerID, name, teamCode, position }, index) => {
            return (
              <div
                key={playerID}
              ...
              >
                ...
                <div className="flex items-center ml-auto">
                  <p className="mr-2 text-base">{teamCode}</p>
